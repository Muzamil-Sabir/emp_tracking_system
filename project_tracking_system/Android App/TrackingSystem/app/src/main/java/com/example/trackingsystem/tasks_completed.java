...
public class tasks_completed extends AppCompatActivity {
    public static  String URL_GET_PENDING_TASKS = "https://ibbys.co.uk/TrackingSystem/API/completed_tasks.php?user_id=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.completed_tasks);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i =new Intent(tasks_completed.this, task_completed_details.class);
...
//                Toast.makeText(getBaseContext(), id + "", Toast.LENGTH_LONG).show();
    ...
    public void get_completed_tasks(){
        ...
        class get_completed_tasks extends AsyncTask<Void, Void, String> {
            ProgressDialog pdLoading = new ProgressDialog(tasks_completed.this);
...
//                            startActivity(intent);
                    ...
                    e.printStackTrace();
                    Toast.makeText(tasks_completed.this, "Exception: " + e, Toast.LENGTH_LONG).show();
                }
            }
        }

        get_completed_tasks get_completed_tasks  = new get_completed_tasks();
        get_completed_tasks.execute();
